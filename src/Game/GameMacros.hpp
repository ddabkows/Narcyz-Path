...
const float _player_movement_mult          = -2.f;
const float _player_movement_trans         = 4.2f;
const float _player_movement_x_trans       = 0.5f;
...
const float _classic_mob_velocity          = 1.6f;
