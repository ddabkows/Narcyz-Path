...
const float _player_acceleration           = 0.05f;
const float _player_max_velocity           = 4.f;
const float _player_movement_mult          = -0.15f;
const float _player_movement_trans         = 6.f;
const float _player_movement_x_trans       = 0.f;
...
const float _classic_mob_velocity          = 4.5f;
const std::size_t _classic_mob_max_count   = 15;
const float _classic_mob_spawn_speed       = 5.f;
const float _classic_mob_max_hp            = 6.f;
...
const float _classic_mob_hit_cooldown      = 1.5f;
...
const float _classic_weapon_cooldown       = 0.5f;
