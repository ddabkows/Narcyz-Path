...
class GameWindow : public Window {
  ...
  public:
    ...
    GameWindow(GUI* gui, std::shared_ptr<sf::RenderWindow> window, std::shared_ptr<Game> game) : Window(gui, window, game),
      ...
      _spawn_message = Text(20.f, 20.f, sf::Color::Black, sf::Color::White, 0.f, _master->getFont1(), _spawn_text);
      _keys_swap = Text(1388.f, 10.f, sf::Color::Black, sf::Color::White, 0.f, _master->getFont1(), _swap_keys_text); 
    }
